...
return 0;//STITCH item stat : suppression des stats sur item stat aleatoires pour cause de bug toujour 1 affiché
...
/* //STITCH : suppression des stats sur item stat aleatoires pour cause de bug toujour 1 affiché
    if (randomPropId > 0)
    {
