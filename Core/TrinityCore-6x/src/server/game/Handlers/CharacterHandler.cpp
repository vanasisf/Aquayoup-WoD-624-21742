...
//	CharacterDatabase.DirectExecute("UPDATE `characters` SET `race` = 25 WHERE `race` = 24 AND `at_login` = 0"); //STITCH a la connexion d'un joueur = tout les Panda en 25
	...
	CharacterDatabase.DirectExecute("UPDATE `characters` SET `race` = 26,`at_login`=0 WHERE `at_login` = 1024 AND (`race` = 2 OR `race` = 5 OR `race` = 6 OR `race` = 8 OR `race` = 10 OR `race` = 9) "); //STITCH a la connexion un joueur H2 deviens Panda H2 - AT_LOGIN_hordeverspanda
