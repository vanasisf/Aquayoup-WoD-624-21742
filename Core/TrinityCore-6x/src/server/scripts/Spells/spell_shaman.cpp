...
INSERT IGNORE INTO `world`.`spell_script_names` (`spell_id`, `ScriptName`) VALUES ('6474', 'spell_sha_earthbind_totem');
INSERT IGNORE INTO `world`.`spell_script_names` (`spell_id`, `ScriptName`) VALUES ('64695', 'spell_sha_earthbind_totem');
INSERT IGNORE INTO `world`.`spell_script_names` (`spell_id`, `ScriptName`) VALUES ('51483', 'spell_sha_earthbind_totem');
INSERT IGNORE INTO `world`.`spell_script_names` (`spell_id`, `ScriptName`) VALUES ('59566', 'spell_sha_earthen_power');
